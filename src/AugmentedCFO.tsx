...
/**
 * ~82-second video (2460 frames @ 30fps) — Dark Premium
 *
 ...
 *  8  Before/After Metrics   0:31–0:43   930–1289     360 fr
 *  9  High-Value Work        0:43–0:49   1290–1469    180 fr
 * 10  How It Works           0:49–0:58   1470–1739    270 fr
 * 11  Services               0:58–1:04   1740–1919    180 fr
 * 12  CTA Final              1:04–1:22   1920–2459    540 fr
 */
export const AugmentedCFO: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#0A0F1E" }}>
      ...
      <Sequence from={930} durationInFrames={360}>
      ...
      <Sequence from={1920} durationInFrames={540}>
